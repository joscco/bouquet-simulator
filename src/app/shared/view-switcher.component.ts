...
@Component({
  ...
  template: `
    <nav
      class="absolute right-4 top-3 z-50 flex items-center rounded-2xl border border-white/70 bg-white/85 p-1 shadow-md shadow-stone-900/10 backdrop-blur-md"
      aria-label="Editor wechseln"
    >
      <a
        class="rounded-xl px-3 py-2 text-xs font-bold transition hover:bg-stone-100 hover:text-stone-900"
